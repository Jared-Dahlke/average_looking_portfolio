...
export function MyCalendar() {
	return (
		<div className='lg:flex lg:h-full lg:flex-col px-8 sm:px-6 lg:px-8 mt-32'>
			<div className='relative'>
				<h2 className='text-left text-3xl font-bold leading-8 tracking-tight text-gray-900 sm:text-4xl'>
					My Calendar
				</h2>
				<p className='mr-auto mt-4 max-w-3xl text-left text-xl text-gray-500'>
