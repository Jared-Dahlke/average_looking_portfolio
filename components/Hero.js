				...
				<main className='mx-auto mt-16 max-w-7xl px-4 sm:mt-24'>
					<div className='text-center'>
						<h1 className='text-4xl font-bold tracking-tight text-gray-900 sm:text-5xl md:text-6xl'>
							<span className='block xl:inline'>Jared Dahlke </span>{' '}
							<span className='block text-indigo-600 xl:inline'>
								front end React developer
							</span>
						</h1>
						<p className='mx-auto mt-3 max-w-md text-base text-gray-500 sm:text-lg md:mt-5 md:max-w-3xl md:text-xl'>
							Website builder for hire. You can pay me in
							<span className='text-indigo-600 xl:inline'> bitcoin </span> or US
							dollars. Still not convinced? Scroll down to see some of my
							components and get a taste for my work.
						</p>
